		...
		if (ImGui::BeginTabBar("tabs"))
		{
			if (ImGui::BeginTabItem("Aimbot"))
			{
				...
				if (conf.aimbot().mode != 0)
				{
					...
					ImGui::Separator();
					ImGui::Checkbox("Head", &conf.aimbot().hitbox.head);
					ImGui::SameLine();
					ImGui::Checkbox("Head Override", &conf.aimbot().hitbox_override.head);
					ImGui::Checkbox("Chest", &conf.aimbot().hitbox.chest);
					ImGui::SameLine();
					ImGui::Checkbox("Chest Override", &conf.aimbot().hitbox_override.chest);
					ImGui::Checkbox("Stomach", &conf.aimbot().hitbox.stomach);
					ImGui::SameLine();
					ImGui::Checkbox("Stomach Override", &conf.aimbot().hitbox_override.stomach);
					ImGui::Checkbox("Legs", &conf.aimbot().hitbox.legs);
					ImGui::SameLine();
					ImGui::Checkbox("Legs Override", &conf.aimbot().hitbox_override.legs);
					ImGui::Checkbox("Arms", &conf.aimbot().hitbox.arms);
					ImGui::SameLine();
					ImGui::Checkbox("Arms Override", &conf.aimbot().hitbox_override.arms);
