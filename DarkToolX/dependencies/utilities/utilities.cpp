...
uint8_t* utilities::pattern_scan(const char* module_name, const char* signature) noexcept {
...
void* utilities::get_export(const char* module_name, const char* export_name)
{
	HMODULE mod;
