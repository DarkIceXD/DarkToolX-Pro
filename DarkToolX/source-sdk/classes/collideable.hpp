...
public:
	...
	void set_collision_bounds(const vec3_t& mins, const vec3_t& maxs) {
		...
		static original_fn set_collision_bounds_fn = (original_fn)((DWORD)utilities::pattern_scan("client.dll", "53 8B DC 83 EC 08 83 E4 F8 83 C4 04 55 8B 6B 04 89 6C 24 04 8B EC 83 EC 18 56 57 8B 7B"));
